# Project Requirements & Technical Test Instructions

> [!NOTE]
> This file contains the original requirements and instructions for the technical test. The main documentation has been moved to `README.md`.
